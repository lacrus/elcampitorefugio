    ...
    <main>
      ...
      <section class="box-container">
        <div class="box background-grey">
          <NavLink to="/">
            <h3>Veterinaria y Unidad de Cuidados Intensivos</h3>
          </NavLink>
        </div>
        <div class="box background-orange">
          <NavLink to="/">
            <h3>Comportamiento y Sociabilizaci&oacute;n</h3>
          </NavLink>
        </div>
        <div class="box background-purple">
          <NavLink to="/donate">
            <h3>Donaciones y Padrinazgos</h3>
          </NavLink>
        </div>
        ...
        <div class="box background-orange">
          <NavLink to="/contact">
            <h3>Comunicaci&oacute;n y Redes Sociales</h3>
          </NavLink>
        </div>
      </section>
    </main>
